...
// Converts a YYYY-MM-DD format into a Date object
export function convertToDate(date) {
    ...
    var day = parseInt(date.substring(hyphens[1] + 1));
    var month = parseInt(date.substring(hyphens[0] + 1, hyphens[1]));
    var year = parseInt(date.substring(0, hyphens[0]));
